$(document).ready(function () {
    ...
    function infospaninteracao(texto) {
        $('<div>', {
            class: 'base-div-info'
        }).append($('<div>', {
    ...
    $('.sobre-eu-competencias-info span').click(function () {
        ...
        if (idSpanB === 'comp-info-p1') {
            infospaninteracao('carameujquery');
        } else if (idSpanB === 'comp-info-p2') {
            infospaninteracao('caracameuhtml')
        } else if (idSpanB === 'comp-info-p3') {
            infospaninteracao('caracameucss');
        } else if (idSpanB === 'comp-info-p4') {
            infospaninteracao('bootstrap');
        } else if (idSpanB === 'comp-info-p5') {
            infospaninteracao('sass');
        }
    });
